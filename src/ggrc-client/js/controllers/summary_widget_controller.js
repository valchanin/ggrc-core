...
export default can.Control({
  ...
  setState: function (type, data, isLoading) {
    ...
    chartOptions.attr('totalEvidences', data.total.evidences);
  ...
  parseStatuses: function (type, raw) {
    ...
    raw.statuses.forEach((item) => {
      ...
      statusObj.evidences = item.evidences;
    });
  ...
  /**
   * Get count of Assessments and mapped evidences with breakdown by status
   ...
   * Y - number of evidences attached to assessments with this status;
   * N, L - total count of assessments, evidences accordingly in this audit.
   */
